...
//  - Queue fullness and almost-emptiness is pre-computed for next cycle
...
//
//  - This file demonstrates a Synplify bug wherein an enabled
//      data shift chain (defined by array) of depth 2
//      infers a register chain instead of SRL16E,
//      even when using attribute:
//           /* synthesis syn_srlstyle="select_srl"      */
//      or:  /* synthesis syn_srlstyle="noextractff_srl" */
//
//  - Synplify 7.1
//  - Eylon Caspi,  9/11/03
...
// parameter addrwidth = LOG2;			// - width of queue addr
   ...
   reg    [width-1:0] 	  srl [depth-1:0]  /* synthesis syn_srlstyle="noextractff_srl" */;
							// - SRL16 memory
   ...
   reg	     addr_full, addr_full_;   // - true iff addr==depth-1 on NEXT cycle
   reg       addr_zero, addr_zero_;   // - true iff addr==0       on NEXT cycle
