...
`ifdef  Q_srl_reserve_lwpipe_bubl
`else
`define Q_srl_reserve_lwpipe_bubl
...
module Q_srl_reserve_lwpipe_bubl (clock, reset, i_d, i_v, i_b, o_d, o_v, o_b);
...
endmodule // Q_srl_reserve_lwpipe_bubl


`endif  // `ifdef  Q_srl_reserve_lwpipe_bubl
