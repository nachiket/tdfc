...
module Q_srl_reserve_driver;
   ...
   Q_srl_reserve #(2, 16, 1) q (clock, reset, X_d, X_v, X_b, Y_d, Y_v, Y_b);
   // 2 deep x 16 bit x 1 reserve
   ...
   initial begin
      ...
      #2000  reset=1;  X_d=1009;  X_v=1;  Y_b=1;	// overflow		--> cap=2;  X_b=1;  Y_v=1;  Y_d=1007;
      #2000  reset=1;  X_d=1010;  X_v=0;  Y_b=0;	//            prod 1007	--> cap=1;  X_b=1;  Y_v=1;  Y_d=1008;
      #2000  reset=1;  X_d=1011;  X_v=1;  Y_b=0;	// cons 1011, prod 1008	--> cap=1;  X_b=1;  Y_v=1;  Y_d=1011;
      #2000  reset=1;  X_d=1012;  X_v=0;  Y_b=0;	//            prod 1011	--> cap=0;  X_b=0;  Y_v=0;  Y_d=X; (1011)
      #2000  reset=1;  X_d=1013;  X_v=0;  Y_b=0;	// underflow		--> cap=0;  X_b=0;  Y_v=0;  Y_d=X; (1011)
      #2000  reset=1;  X_d=1014;  X_v=0;  Y_b=1;	// idle			--> cap=0;  X_b=0;  Y_v=0;  Y_d=X; (1011)
      #2000  reset=1;  X_d=1015;  X_v=1;  Y_b=1;	// cons 1015		--> cap=1;  X_b=1;  Y_v=1;  Y_d=1015;
      #2000  reset=1;  X_d=1016;  X_v=0;  Y_b=1;	// idle			--> cap=1;  X_b=1;  Y_v=1;  Y_d=1015;
