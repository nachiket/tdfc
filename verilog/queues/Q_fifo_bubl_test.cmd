#!/bin/csh
#
# Run Q_fifo_bubl_*.v through synplify with different depth/width parameters
#
# Synplify 7.1
# Eylon Caspi,  9/18/03

set verilog_input  = Q_fifo_bubl_test_template.v
set verilog_output = Q_fifo_bubl_test.v
set module         = Q_fifo_bubl_test

foreach verilog (Q_fifo_bubl.v)
  foreach depth (1 2 4 8 16 32 64 128)		# depth 256 too slow
