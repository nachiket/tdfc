...
module Q_srl_reserve_driver;
   ...
   initial begin
      ...
      #2000  reset=1;  X_d=1010;  X_v=0;  Y_b=0;	//            prod 1007	--> cap=2;  X_b=0;  Y_v=1;  Y_d=1008;
      #2000  reset=1;  X_d=1011;  X_v=1;  Y_b=0;	// cons 1011, prod 1008	--> cap=2;  X_b=0;  Y_v=1;  Y_d=1009;
