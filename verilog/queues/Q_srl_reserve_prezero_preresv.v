// Q_srl_reserve_prezero_preresv.v
//
...
//  - Queue almost-emptiness and reserve mode is pre-computed for next cycle
...
//		 state_     <= addr_zero ? state_empty : state_nonempty;
		 ...
		 addr_resv_ <= addr_zero ? 0 : (addr >= depth-reserve);  // (a-1>=d-1-r)
		 state_     <= addr_zero ? state_empty : state_nonempty;
	      end
