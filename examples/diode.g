...
minus_15_m float<ieee_64,ne> = ( exp_13_m - 1 );
divide_16_m float<ieee_64,ne> = ( multiply_14_m / vj_m );
multiply_17_m float<ieee_64,ne> = ( isat_m * minus_15_m );
gm_m float<ieee_64,ne> =  ( divide_16_m );
i_m float<ieee_64,ne> =  ( multiply_17_m );
...
minus_15_fl float<ieee_32,ne> = ( exp_13_fl - 1 );
divide_16_fl float<ieee_32,ne> = ( multiply_14_fl / vj_fl );
multiply_17_fl float<ieee_32,ne> = ( isat_fl * minus_15_fl );
gm_fl float<ieee_32,ne> =  ( divide_16_fl );
i_fl float<ieee_32,ne> =  ( multiply_17_fl );
...
minus_15_dbl float<ieee_64,ne> = ( exp_13_dbl - 1 );
divide_16_dbl float<ieee_64,ne> = ( multiply_14_dbl / vj_dbl );
multiply_17_dbl float<ieee_64,ne> = ( isat_dbl * minus_15_dbl );
gm_dbl float<ieee_64,ne> =  ( divide_16_dbl );
i_dbl float<ieee_64,ne> =  ( multiply_17_dbl );
